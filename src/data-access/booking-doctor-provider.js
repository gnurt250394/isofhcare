...
export default {
    ...
    return new Promise((resolve, reject) => {
      client.requestApi(
        ...
        client.serviceSchedule +
          ...
          `/${idSpecialist}/specialization?page=${page}&size=${size}&sort=desc&properties=created`,
        {},
        (s, e) => {
          if (s) resolve(s);
          reject(e);
  ...
  searchListDoctorWithSpecialist(idSpecialist, name, page, size) {
    return new Promise((resolve, reject) => {
      client.requestApi(
        ...
        client.serviceSchedule +
          constants.api.booking.doctor.get_detail_doctor +
          `/${idSpecialist}/specialization?name=${name}&page=${page}&size=${size}&sort=desc&properties=created`,
        {},
        (s, e) => {
          if (s) resolve(s);
          reject(e);
  ...
  getListDoctorWithHospital(idHospital, page, size) {
    return new Promise((resolve, reject) => {
      client.requestApi(
        ...
        client.serviceSchedule +
          constants.api.booking.doctor.get_detail_doctor +
          `/hospital/${idHospital}/top/?page=${page}&size=${size}`,
        {},
        (s, e) => {
          if (s) resolve(s);
          reject(e);
  ...
  detailHospital(id) {
    return new Promise((resolve, reject) => {
      client.requestApi(
        'get',
        constants.api.hospital.get_details_hospital + '/' + id,
        {},
        (s, e) => {
          if (s) resolve(s);
          else reject(e);
  ...
  create(
    ...
    return new Promise((resolve, reject) => {
      let doctors = {
        ...
        academicDegree: doctor?.academicDegree?.value,
      };
      let hospital = {
        id: (hospitals && hospitals.id) || '',
        name: (hospitals && hospitals.name) || '',
        address: (hospitals && hospitals.contact.address) || '',
        checkInPlace: (hospitals && hospitals.checkInPlace) || '',
        hotLine: (hospitals && hospitals.hotLine) || '',
        bank:
          (hospitals &&
            hospitals.transferInfo &&
            hospitals.transferInfo.bank) ||
          '',
        accountNo:
          (hospitals &&
            hospitals.transferInfo &&
            hospitals.transferInfo.accountNo) ||
          '',
        owner:
          (hospitals &&
            hospitals.transferInfo &&
            hospitals.transferInfo.owner) ||
          '',
        branch:
          (hospitals &&
            hospitals.transferInfo &&
            hospitals.transferInfo.branch) ||
          '',
        note:
          (hospitals &&
            hospitals.transferInfo &&
            hospitals.transferInfo.note) ||
          '',
      };
      ...
      client.requestApi(
        'post',
        client.serviceBooking + constants.api.booking.doctor.create_booking,
        {
          // ngày đặt khám
          date,
          // mô tả
  ...
  get_list_hospitals(page, size) {
    return new Promise((resolve, reject) => {
      client.requestApi(
        ...
        client.serviceSchedule +
          `${
            constants.api.booking.doctor.get_list_hospitals
          }?page=${page}&size=${size}`,
        {},
        (s, e) => {
          if (s) resolve(s);
  ...
  get_list_schedules(hospitalId, doctorId, page, size) {
    return new Promise((resolve, reject) => {
      client.requestApi(
        ...
        // client.serviceSchedule +
        `${
          constants.api.booking.doctor.get_list_schedules
        }/${hospitalId}?page=0&size=20`,
        {},
        (s, e) => {
          if (s) resolve(s);
          else reject(e);
  ...
  get_list_specialists(page, size) {
    return new Promise((resolve, reject) => {
      client.requestApi(
        ...
        client.serviceSchedule +
          `${
            constants.api.booking.doctor.get_list_specialists
          }?page=${page}&size=${size}&sort=asc&properties=ordinalNumbers`,
        {},
        (s, e) => {
          if (s) resolve(s);
          else reject(e);
  ...
  search_list_specialists(name) {
    return new Promise((resolve, reject) => {
      client.requestApi(
        ...
        client.serviceSchedule +
          `${
            constants.api.booking.doctor.search_list_specialists
          }?name=${name}`,
        {},
        (s, e) => {
          if (s) resolve(s);
  ...
  get_doctor_hospitals(hospitalId, page, size) {
    return new Promise((resolve, reject) => {
      let url = constants.api.booking.doctor.get_doctor_hospitals.replace(
        'hospitalId',
        hospitalId,
      );
      client.requestApi(
        'get',
        client.serviceSchedule + `${url}?page=${page}&size=${size}`,
        {},
        (s, e) => {
          if (s) resolve(s);
          else reject(e);
  ...
  get_doctor_specialists(specialistId, page, size) {
    return new Promise((resolve, reject) => {
      let url = constants.api.booking.doctor.get_doctor_specialists.replace(
        'specialistId',
        specialistId,
      );
      client.requestApi(
  ...
  getListBooking(phoneProfile, patientId, page, size) {
    return new Promise((resolve, reject) => {
      let url = constants.api.booking.doctor.get_list_booking.replace(
        'patientId',
        patientId,
      );
      client.requestApi(
  ...
  getListTimeBooking(doctorId, isOnline, fromDate, toDate) {
    return new Promise((resolve, reject) => {
      client.requestApi(
        ...
        client.serviceSchedule +
          `${
            constants.api.booking.doctor.get_list_time_booking
          }?doctorId=${doctorId}&isOnline=${isOnline}&fromDate=${fromDate}&toDate=${toDate}`,
        {},
        (s, e) => {
          if (s) resolve(s);
          else reject(e);
