...
class MyProgram extends Component {
    ...
    render() {
        return (
            <Program ref={ref => this.program = ref} isMyProgram={true} loadDataListener={this.loadData.bind(this)} />
        );
    }
}
...
export default connect(mapStateToProps, null, null, { withRef: true })(MyProgram);