    ...
    render() {
      ...
      <Card style={styles.viewDetails}>
        ...
        <TouchableOpacity style = {styles.btnStore}>
          <ScaledImage height = {15} source={require('@images/new/home/ic_store.png')}></ScaledImage>
          <Text style={styles.txStore}>Đặt hàng ngay</Text>
          <ScaledImage height = {5} source={require('@images/new/home/ic_next2.png')}></ScaledImage>
        </TouchableOpacity>
        <ScaledImage height = {15} source= {require('@images/new/home/ic_hearth.png')}></ScaledImage>
        </View>
      </Card>
    </View>
        );
