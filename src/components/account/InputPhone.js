        ...
        return (
            ...
            <Modal
                ...
                <View style={styles.scroll}>
                    ...
                    >
                        <Text style={styles.txPhone}>CẬP NHẬT SỐ ĐIỆN THOẠI</Text>
                        <Text style={styles.txContent}>Vui lòng cập nhật SĐT của bạn để nhận tin nhắn xác minh khi đặt khám hoặc thay đổi mật khẩu.</Text>
                    </View>
