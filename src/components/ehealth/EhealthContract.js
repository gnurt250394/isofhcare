...
class EhealthItem extends Component {
      ...
      <View>
        ...
        <View style={styles.conclusion}>
          {conclusion.classification ? (
            <View style={{ flex: 1 }}>
              <Text style={styles.labelConclusion}>{'Phân loại sức khoẻ'}</Text>
              <View style={styles.viewRow}>
                <ScaleImage
                  source={require('@images/new/ehealth/ic_dot.png')}
                  width={5}
          ...
          {conclusion.diseases ? (
            <View style={{ flex: 1 }}>
              <Text style={styles.labelConclusion}>{'Các bệnh tật'}</Text>
              <View style={styles.viewRow}>
                <ScaleImage
                  source={require('@images/new/ehealth/ic_dot.png')}
                  width={5}
          ...
          {conclusion.location ? (
            <View style={{ flex: 1 }}>
              <Text style={styles.labelConclusion}>{'Nơi thực hiện'}</Text>
              <View style={styles.viewRow}>
                <ScaleImage
                  source={require('@images/new/ehealth/ic_dot.png')}
                  width={5}
          ...
          {conclusion.note ? (
            <View style={{ flex: 1 }}>
              ...
              <View style={styles.viewRow}>
                ...
                />
                <View style={{ width: '100%' }}>
                  <Text style={styles.valueConclusion}>{conclusion.note}</Text>
                </View>
              </View>
            </View>
          ) : null}
          {conclusion.doctor ? (
            <View style={{ flex: 1 }}>
              <Text style={styles.labelConclusion}>{'Bác sĩ'}</Text>
              <View style={styles.viewRow}>
                <ScaleImage
                  source={require('@images/new/ehealth/ic_dot.png')}
                  width={5}
  ...
  renderService = (label, list) => {
    ...
    return (
      <View>
        <View style={styles.viewServiceName}>
          <Text style={styles.txServiceName}>{label}</Text>
          <View style={styles.viewBorder} />
        </View>
        <View style={styles.conclusion}>
          {list.map((e, i) => {
            ...
            return (
              <View key={i} style={{ flex: 1 }}>
                <Text style={styles.labelConclusion}>{e.title}</Text>
                <View style={styles.viewRow}>
                  <ScaleImage
                    source={require('@images/new/ehealth/ic_dot.png')}
                    width={5}
                  ...
                  />
                  <View style={{ width: '100%' }}>
                    <Text style={styles.valueConclusion}>{e.result}</Text>
                  </View>
                </View>
              </View>
            );
  ...
  render() {
    ...
    return (
      <View style={styles.container} key={this.props.index}>
        <View>
          {this.renderResult(medical.conclude)}
          {this.renderService('Khám Nam khoa', medical.specialists.andrology)}
          {this.renderService('Khám Da liễu', medical.specialists.dermatology)}
          {this.renderService('Khám Tim mạch', medical.specialists.cardiology)}
          {this.renderService(
            'Khám Nội tiết',
            medical.specialists.endocrinology,
          )}
          {this.renderService(
            'Khám Tiêu hoá',
          ...
          {this.renderService(
            'Khám Sản phụ khoa',
            medical.specialists.gynecology,
          )}
          {this.renderService(
            'Khám Dị ứng miễn dịch',
            medical.specialists.immunology,
          )}
          {this.renderService(
            'Khám Nội khoa',
            medical.specialists.internalMedicine,
          )}
          {this.renderService(
            'Khám thần kinh',
            medical.specialists.neurosurgery,
          )}
          {this.renderService('Khám RHM', medical.specialists.odontology)}
          {this.renderService('Khám Ung bướu', medical.specialists.oncology)}
          {this.renderService('Khám Mắt', medical.specialists.ophthalmology)}
          {this.renderService(
            'Khám Cơ xương khớp',
            medical.specialists.osteoarthritis,
          )}
          {this.renderService('Khám tâm thần', medical.specialists.psychiatric)}
          {this.renderService('Khám Hô hấp', medical.specialists.respiratory)}
          {this.renderService('Khám Ngoại khoa', medical.specialists.surgery)}
          {this.renderService(
            'Khám bệnh nghề nghiệp',
            medical.specialists.occupational,
          )}
        </View>
      </View>
    );
