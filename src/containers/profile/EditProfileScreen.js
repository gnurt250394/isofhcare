    ...
    componentDidMount() {
        ...
        if (dataOld) {
            ...
            this.setState({
                ...
                this.renderAddress()
                this.onLoadDefault(dataProfile?.nation || null, dataProfile?.job || null, dataProfile?.nationality || null)
            });
        } else {
                        ...
                        () => {
                            ...
                            if (id) {
                                profileProvider.updateProfile(id, data).then(res => {
                                    ...
                                    this.props.navigation.replace('profile', { id: res.userProfileId })
