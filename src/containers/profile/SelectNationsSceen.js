...
class SelectNationsSceen extends Component {
  constructor(props) {
    super(props);
    let nations = this.props.navigation.getParam('nations', {});
    this.state = {
      listService: [],
      listServiceSearch: [],
      searchValue: '',
    ...
    return !this.state.refreshing &&
      ...
      <View style={styles.containerSearchValue}>
        ...
        <Text>
          ...
          <Text style={styles.txtSeatchValue}>{this.state.searchValue}</Text>
        </Text>
      </View>
    ) : null;
  };
...
export default connect(mapStateToProps)(SelectNationsSceen);
