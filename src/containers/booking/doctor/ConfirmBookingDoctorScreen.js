        ...
        <View style={styles.container}>
          <ScrollView keyboardShouldPersistTaps="handled" style={styles.flex}>
                  ...
                  <View style={styles.containerServices}>
                    <View style={styles.flex}>
                      ...
                      <Text
                        ...
                        ({parseInt(service.price).formatPrice()}đ){' '}
                      </Text>
                    </View>
                  </View>
                </View>
                  ...
                  <View style={styles.containerServices}>
                    <View style={styles.flex}>
                      ...
                      <Text
                        ...
                        Giảm {this.renderPromotion(service)}
                      </Text>
                    </View>
                  </View>
                </View>
                ...
                {this.state.voucher && this.state.voucher.price ? (
                  <Text
                    style={[
                      ...
                      styles.flex,
                    ]}>{`GIẢM ${this.state.voucher.price.formatPrice()}đ KHI ĐẶT KHÁM`}</Text>
                ) : null}
              </View>
              ...
              {this.state.voucher && this.state.voucher.price ? (
                <View style={[styles.containerVoucher, {paddingBottom: 5}]}>
                  ...
                  <Text
                    ...
                    -{this.state.voucher.price.formatPrice()}đ
                  </Text>
                </View>
              ) : null}
              {service && service.price ? (
                <View style={styles.containerVoucher}>
                  ...
                  <Text style={styles.sumPrice}>
                    {this.getPrice(service, voucher).formatPrice()}đ
                  </Text>
                </View>
              ) : null}
            </View>
            ...
            <Text style={styles.txtHelper}>
              Nếu số tiền thanh toán trước cao hơn thực tế, quý khách sẽ nhận
              lại tiền thừa tại CSYT khám bệnh
            </Text>
            <ButtonPayment
              booking={booking}
