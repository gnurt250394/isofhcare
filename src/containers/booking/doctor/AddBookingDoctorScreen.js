...
class AddBookingDoctorScreen extends Component {
        ...
        if (this.imagePicker) {
          this.imagePicker
            ...
            .catch(err => {
              if (err) {
                snackbar.show(
                  'Định dạng ảnh không được hỗ trợ hoặc ảnh đã bị hỏng vui lòng chọn ảnh khác',
                  'danger',
                );
              }
            });
            ...
            <View style={styles.groupService}>
              ...
              {hospital && hospital.name ? (
                <View style={styles.containerPrice}>
                  ...
                  <Text style={styles.txtPrice}>
                    {hospital.monetaryAmount.value.formatPrice()}đ{' '}
                  </Text>
                </View>
              ) : null}
            </View>
          ...
          <View style={styles.flexRow}>
            ...
            <View style={styles.groupService}>
              ...
              <View style={styles.containerPrice}>
                ...
                <Text style={styles.txtPrice}>
                  Giảm {this.renderPromotion(service.promotion)}{' '}
                </Text>
              </View>
            </View>
          </View>
  ...
  render() {
    ...
    return (
      <ActivityPanel
        title={isOnline ? 'Thông tin lịch gọi' : 'Thông tin đặt khám'}
