...
class SelectHospitalScreen extends Component {
    ...
    this.setState(
      ...
      () => {
        ...
        if (this.state.region) {
          promise = hospitalProvider.getByLocation(
            page,
            size,
  ...
  selectHospital(item) {
    ...
    let isBooking = this.props.navigation.getParam('isBooking', false);
    if (isBooking) {
  ...
  renderItem = ({item, index}) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={this.selectHospital.bind(this, item)}>
        <View style={styles.containerImage}>
          ...
          {this.state.region && (
            ...
            <Text style={styles.bv1}>
              {(Math.round(item.hospital.distance * 100) / 100).toFixed(2)} km
            </Text>
          )
          // </View>
          }
        ...
        <View style={styles.groupContent}>
          <Text style={styles.bv} numberOfLines={2}>
            {item.hospital.name}
          </Text>
  ...
  render() {
    return (
      <ActivityPanel
        ...
        title={constants.title.location}
        backButton={
          <TouchableOpacity
        ...
        <View style={styles.container}>
          <TouchableOpacity
            ...
            <ScaleImage
              style={styles.aa}
              width={18}
              source={require('@images/new/hospital/ic_placeholder.png')}
            />
            <Text style={styles.tkdiachi}>
              {constants.booking.location_around}
            </Text>
          </TouchableOpacity>
