        ...
        return (
            <ActivityPanel
                ...
                <View style={{ padding: 15 }}>
                    ...
                    <Text style={styles.content}>Hoạt động của ISOFHCARE được xây dựng trên nền tảng sự tin tưởng giữa ban với chúng tôi. Nhằm bảo mật thông tin cá nhân bạn cung cấp cho chúng tôi, ISOFHCARE luôn tuân thủ những nguyên tắc bảo mật sau:</Text>
                    ...
                    <Text style={styles.content}>•	Thông tin sức khỏe cá nhân là toàn bộ thông tị về bệnh án, hình ảnh bạn cung cấp cho bác sĩ, lịch sử sử dụng dịch vụ và các thông tin khác liên quan đến sức khỏe của bạn.</Text>
                    ...
                    <Text style={styles.content}>ISOFHCARE có quyền thu thập và sử dụng thông tin cá nhân, thông tin tổng hợp để phục vụ cho quá trình vận hành, nghiên cứu, phất triển sản phẩm và dịch vụ của chúng tôi.</Text>
                    ...
                    <Text style={styles.content}>Chúng tôi duy trì cam kết bảo mật dữ liệu này bằng cách áp dụng những biện pháp vật lý, điện tử hiện đại và an toàn nhất để bảo vệ dữ liệu cá nhan của quý khách.</Text>
                    ...
                    <Text style={styles.content}>Tuy nhiên, chúng là một phần quan trọng trong cách thức hoạt động của Dịch vụ của chúng tôi, vì vậy bạn cần lưu ý rằng nếu bạn chọ từ chối hoặc xóa các cookie, điều này có thể ảnh hưởng tới tình trạng sẵn có và chức năng của Dịch vụ.</Text>
                    ...
                    <Text style={styles.content}>Trẻ em chỉ được sử dụng dịch vụ tư vấn của sức khỏe của ISOFHCARE khi có sự giám sát của bố mẹ hoặc người giám hộ.</Text>
                    <Text style={styles.content}>Mọi thông tin về sức khỏe, mọi thông tin cá nhân cũng như các thông tin khác bắt buộc phải lưu trữ trong tài khoản của bố mẹ hoặc người dám hộ như là một phàn của hồ sơ y tế gia đình.</Text>
