            ...
            <ActivityPanel
                ...
                >
                    <View style={{ padding: 15 }}>
                        ...
                        <Text style={styles.content}>Địa chỉ email: <Text style={{ color: 'blue' }}>cskh@isofhcare.com</Text> hoặc Công ty cổ phần công nghệ iSofH. Địa chỉ: Tầng 6, Tòa nhà FORD, 313-315 Trường Chinh, Thanh Xuân Hà Nội (6th Floor, Ford Building, 313-315 Truong Chinh, Thanh Xuan District, Hanoi, Vietnam).</Text>
