                ...
                <ScrollView>
                    <View style={{ padding: 15 }}>
                        ...
                        <Text style={styles.content}>
                            Thỏa thuận này có thể được cập nhật thường xuyên bởi Isora, phiên bản cập nhất sẽ được chúng tôi công bố tại website: http://iSofH.com/cdyt/dieukhoan. Phiên bản cập nhật này sẽ thay thế cho các quy định và điều kiện trong thỏa thuận ban đầu. Bạn có thể truy cập vào ứng dụng hoặc vào website trên đây để xem nội dung chi tiết của phiên bản cập nhật.
                        </Text>
                        ...
                        <Text style={styles.content}>•  Sử dụng Ứng dụng để sứ dụng, đăng tải, chuyển, truyền hoặc lưu trữ bất kỳ nội dung vi phạm quyền sở hữu trí tuệ, bí mật kinh doanh hoặc quyền pháp lý của bên thứ ba;</Text>
                        <Text style={styles.content}>•  Sử dụng Ứng dụng hoặc các dịch vụ khác được cung cấp bới ISofH trong bất kỳ hình thức vi phạm pháp luật nào, cho bất kỳ mục đích bất kỳ hợp pháp nào;</Text>
                        ...
                        <Text style={styles.content}>(a) Khi sử dụng Ứng dụng, bạn thừa nhận rằng chúng tôi có quyền sử dụng những ISofH hệ thống sau để truy cập vào dữ liệu trên điện thoại của bạn: (1) Đọc và ghi vào danh bạ điện thoại, (2) Lấy vị trí hiện tại của bạn khi được sự đồng ý, (3) Ghi dữ liệu của Ứng dụng lên thẻ nhớ, (4)Truy cập vào Internet từ thiết bị của bạn. Tất cả các truy cập này đêu được chúng tôi thực hiện sau khi có sự đồng ý của bạn, vì vậy bạn cam kết và thừa nhận rằng, khi bạn đã cấp quyền cho chúng tôi, bạn sẽ không có bất kỳ khiếu nại nào đối với ISofH về việc truy cập này.</Text>
                        ...
                        <Text style={styles.content}>Địa chỉ email: support@iSofHcare.com hoặc Công ty cổ phần công nghệ iSofH. Địa chỉ: BT1, D15 khu đô thị mới Trung Văn, Nam Từ Liêm, Hà Nội.</Text>
