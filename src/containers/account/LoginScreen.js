...
class LoginScreen extends Component {
  ...
  handleFingerprintShowed = () => {
    this.setState({ isShowFigner: true });
  };

  handleFingerprintDismissed = () => {
    this.setState({ isShowFigner: false });
  };
  ...
  login() {
    ...
    this.setState({ isLoading: true }, () => {
      userProvider
        .login(this.state.email.trim(), this.state.password)
        .then(s => {
          ...
          switch (s.code) {
            case 0:
              ...
              dataCacheProvider
                .read("", constants.key.storage.KEY_FINGER, s => {
                  ...
                  if (s && s.userId !== user.id) {
                    dataCacheProvider.save(
                      "",
                      constants.key.storage.KEY_FINGER,
                      {
                        userId: "",
                        refreshToken: ""
                      }
          ...
          <KeyboardAvoidingView behavior="padding">
            <View style={{ flex: 1 }}>
                  ...
                  <Form ref={ref => (this.form = ref)}>
                    ...
                    <View style={{ flexDirection: "row", marginTop: 15 }}>
                      ...
                      >
                        ...
                        <ScaleImage
                          source={require("@images/new/right_arrow.png")}
                          height={10}
                        />
                      </TouchableOpacity>
                    </View>
              ...
              <Modal
                animationType="fade"
                transparent={true}
                isVisible={this.state.isShowFigner}
                // onRequestClose={() => {}}
              >
                <FingerprintPopup
  ...
  onFigner = async () => {
    ...
    // const isChecked = await dataCacheProvider.read("", "key_finger");
    // console.log(isChecked, "sadasuyasuysaugsau");
    // if (!isChecked) {
    //   alert("đéo cho đăng ký");
    // } else {
    //   this.setState({
    //     isShowFigner: true
    //   });
