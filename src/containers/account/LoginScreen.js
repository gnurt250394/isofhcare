    ...
    connectionUtils
      ...
      .then(s => {
        this.setState({isLoading: true, disabled: true}, () => {
          userProvider
            .login(this.state.phone.trim(), this.state.password)
            .then(s => {
              switch (s.code) {
                case 0:
      ...
      RNFingerprintChange.hasFingerPrintChanged(
        ...
        fingerprintHasChanged => {
          if (fingerprintHasChanged) {
            ...
            snackbar.show(
              'Bạn đã thay đổi vân tay mới, vui lòng đăng nhập để kích hoạt lại chức năng đăng nhập vân tay',
              'danger',
            );
          } else {
            this.setState({
          ...
          <View style={styles.viewCard}>
            <View style={styles.viewLogin}>
              <Card style={styles.cardLogin}>
                <ScaleImage
                  style={styles.imgIsc}
                  source={require('@images/new/account/ic_login_isc.png')}
                  height={60}
                />
                ...
                <View style={styles.viewBtn}>
                  ...
                  {this.state.isSupportSensor && (
                    <TouchableOpacity
                      onPress={this.onFinger}
                      style={styles.btnImgFinger}>
                      <ScaleImage
                        style={styles.imgFinger}
                        source={require('@images/new/finger/ic_finger_login.png')}
                        height={40}
                      />
                    </TouchableOpacity>
                  )}
