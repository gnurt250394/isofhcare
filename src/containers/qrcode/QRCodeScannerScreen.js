  ...
  async componentDidMount() {
    if (Platform.OS == 'android') {
      ...
      const granted = await PermissionsAndroid.requestMultiple(perms, {
        ...
        message:
          'Cho phép iSofHcare truy cập vào ảnh, phương tiện và tệp trên thiết bị của bạn',
  ...
  render() {
    ...
    return (
      <ActivityPanel
        ...
        title={this.state.title || constants.title.scan_qr_code}>
        {isFocused && (
          <QRCodeScanner
            // reactivate={true}
            flashOn={this.state.flashOn}
            ...
            topContent={
              <Text style={styles.centerText}>
                {this.state.textHelp || constants.qr_code.move_camera}
              </Text>
            }
            bottomContent={
              <View style={styles.containerBottom}>
                ...
                <View style={styles.containerFlash}>
                  <TouchableOpacity
                    onPress={this.onTurnOnFlash}
                    style={styles.buttonFlash}>
                    <ScaledImage
                      source={require('@images/ic_flash.png')}
                      height={19}
                      width={19}
                      style={{
                        tintColor: this.state.flashOn ? '#FFF' : '#00000030',
                      }}
                    />
                  </TouchableOpacity>
                </View>
                <View style={styles.containerFlash}>
                  <TouchableOpacity
                    onPress={this.onChangeCamreraType}
                    style={styles.buttonFlash}>
                    <ScaledImage
                      ...
                      width={19}
                      style={{
                        tintColor: this.state.front ? '#FFF' : '#00000030',
                      }}
                    />
                  </TouchableOpacity>
                </View>
