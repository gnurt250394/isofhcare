...
import { View, Text, FlatList, TouchableOpacity, Image, Dimensions, StyleSheet, PixelRatio } from 'react-native'
    ...
    const formatData = (data) => {
        if (data.length == 0) {
            ...
            if (state.page == 0) {
                ...
                setState({ ...state, data: [...state.data, ...data], isLoading: false, refreshing: false })
            }
        }
    }
