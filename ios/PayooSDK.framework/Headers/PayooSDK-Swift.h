...
SWIFT_PROTOCOL("_TtP8PayooSDK10AnchorView_")
@protocol AnchorView
...
SWIFT_CLASS("_TtC8PayooSDK8DropDown")
...
@interface DropDown (SWIFT_EXTENSION(PayooSDK))
...
@interface DropDown (SWIFT_EXTENSION(PayooSDK)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC8PayooSDK12DropDownCell")
...
@interface DropDownCell (SWIFT_EXTENSION(PayooSDK))
- (void)awakeFromNib;
...
@property (nonatomic, strong) NSNumber * _Nullable supportedPaymentMethods;
@property (nonatomic, copy) NSString * _Nullable bankCode;
@property (nonatomic, copy) NSString * _Nullable itemCode;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface UIBarButtonItem (SWIFT_EXTENSION(PayooSDK)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIView (SWIFT_EXTENSION(PayooSDK)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
